...
/**
 * Template Name: Home - EHE w/ Slider
 *
 */

add_action( 'genesis_meta', 'atmosphere_home_v2_genesis_meta' );
/**
 * Add widget support for homepage. If no widgets active, display the default loop.
 *
 * @since 1.0.0
 */
function atmosphere_home_v2_genesis_meta() {
	...
	if ( is_active_sidebar( 'front-page-1' ) || is_active_sidebar( 'front-page-2' ) || is_active_sidebar( 'front-page-3' ) || is_active_sidebar( 'front-page-4' ) ) {
		...
		add_action( 'wp_enqueue_scripts', 'atmosphere_home_v2_backstretch_scripts' );
		...
		add_action( 'genesis_loop', 'atmosphere_home_v2_widgets' );
...
function atmosphere_home_v2_backstretch_scripts() {
...
function atmosphere_home_v2_widgets() {

	echo '<h2 class="screen-reader-text">' . __( 'Main Content', 'atmosphere-pro' ) . '</h2>';
	
	genesis_widget_area( 'front-page-slider', array(
		'before' => '<div id="front-page-slider" class="front-page-slider"><div class="widget-area"><div class="wrap">',
		'after'  => '</div></div></div>',
	) );
